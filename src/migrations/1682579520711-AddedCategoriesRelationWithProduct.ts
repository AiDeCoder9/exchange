...
export class AddedCategoriesRelationWithProduct1682579520711 implements MigrationInterface {
    name = 'AddedCategoriesRelationWithProduct1682579520711'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "product_categories_category" ("productId" bigint NOT NULL, "categoryId" bigint NOT NULL, CONSTRAINT "PK_17f2a361443184000ee8d79f240" PRIMARY KEY ("productId", "categoryId"))`);
